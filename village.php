            ...
            <div class="col-lg-9"  style="margin-left:0;padding:0;">
                ...
                <div style="display:none; margin-bottom:2%;"  class="d-flex flex-fill flex-nowrap">
                   ...
                   <div  class="Bamin trans">
                    ...
                    <div  class="Kharsingsa_Village trans">
                        <svg version="1.1" class="viz" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 50 500" style="enable-background:new 0 0 50 500;" xml:space="preserve">
                            <style type="text/css">
                                .st0 {
                                    fill: #FFFFFF;
                    ...
                    <div  class="Karsingsa_Complex trans">
                        <svg version="1.1" class="viz" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 50 500" style="enable-background:new 0 0 50 500;" xml:space="preserve">
                            <style type="text/css">
                                .st0 {
                                    fill: #FFFFFF;
                   ...
                   <div  class="Old_Changlang trans">
                    ...
                    <div  class="Molyang_Tajang trans">
                        <svg version="1.1" class="viz" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 50 500" style="enable-background:new 0 0 50 500;" xml:space="preserve">
                            <style type="text/css">
                                .st0 {
                                    fill: #FFFFFF;
        ...
        function updateGraph(shg, water_and_sanitation, agriculture, finance, food_and_supplies, energy_and_ict, healthcare, animal_husbandry, fisheries, lodging_and_boarding, tourism, handloom_and_handicraft, education, security) {
            ...
            $.getJSON("public/village.json", function(data) {
                ...
                for (let i = 1; i <= order.length; i++) {
                    ...
                    $('.'.concat(order[i-1].name)).attr('class',order[i-1].name.concat(' order-'.concat(107-i)));
